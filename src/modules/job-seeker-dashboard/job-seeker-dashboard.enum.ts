export const JOB_SEEKER_DASHBOARD_MESSAGES = {
    JOB_SEEKER_APPLIED_JOBS_DATA_FETCHED: 'Job seeker applied jobs data fetched successfully',
    JOB_SEEEKER_JOB_ALERTS_DATA_FETCHED: 'Job seeker job alerts data fetched successfully',
